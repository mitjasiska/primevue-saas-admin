<template>
  <div class="items center flex">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" class="h-6">
    ...
    <div>
      <span class="text-xl font-bold text-slate-950">Saas</span>
      <span class="text-[0.938rem] font-bold text-slate-500">Admin</span>
    </div>
  </div>
</template>
